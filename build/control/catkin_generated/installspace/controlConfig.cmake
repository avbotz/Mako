...
if("FALSE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/user/Mako/src/control)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/user/Mako/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/user/Mako/install/lib;/home/user/Mako/devel/lib;/opt/ros/melodic/lib)
